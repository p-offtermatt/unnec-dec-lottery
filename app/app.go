...
var (
	...
	maccPerms = map[string][]string{
		...
		lotterymoduletypes.ModuleName: {authtypes.Minter, authtypes.Burner, authtypes.Staking},
	}
)
...
type App struct {
	*baseapp.BaseApp
	...
	ScopedLotteryKeeper capabilitykeeper.ScopedKeeper
...
func New(
	...
	*/
	...
	scopedLotteryKeeper := app.CapabilityKeeper.ScopeToModule(lotterymoduletypes.ModuleName)
	app.ScopedLotteryKeeper = scopedLotteryKeeper
	...
	lotteryIBCModule := lotterymodule.NewIBCModule(app.LotteryKeeper)
	...
	ibcRouter.AddRoute(lotterymoduletypes.ModuleName, lotteryIBCModule)
